...
function ProductModal({ ref, type, ...props }) {
...
function CreateAndEditContent({product, onChange,
  ...
  return (
    <>
      ...
      <div className="modal-footer">
        ...
        <button type="button" className="btn btn-primary" onClick={onSave}>確認</button>
      </div>
    </>
  )
}
